    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-opacity-50 backdrop-blur-sm p-4">
      <div className="bg-gradient-to-br from-[#0a2342] to-[#123158] rounded-3xl p-6 sm:p-8 w-full max-w-md shadow-2xl border border-[#03045e] relative">
        ...
        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
          ...
          {/* Email Input (only enabled if empty) */}
          <input
            type="email"
            name="email"
            ...
            ${
              formData.email === ""
                ? "border-[#90e0ef] focus:outline-none focus:ring-2 focus:ring-[#00b4d8] bg-[#caf0f8]/10 text-white placeholder-white"
                : "border-gray-500 bg-gray-700/30 text-gray-400 placeholder-gray-400 cursor-not-allowed opacity-70"
            }`}
          />
