...
const nursePackages = [
  {
    ...
    price: "R200",
    icon: <FaUserNurse className="text-4xl sm:text-5xl lg:text-6xl text-[#03045e]" />,
  },
  {
    ...
    price: "R400",
    icon: <FaSyringe className="text-4xl sm:text-5xl lg:text-6xl text-[#03045e]" />,
  },
  {
    ...
    price: "R600",
    icon: <FaNotesMedical className="text-4xl sm:text-5xl lg:text-6xl text-[#03045e]" />,
  },
];
