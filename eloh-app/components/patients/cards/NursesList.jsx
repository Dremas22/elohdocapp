...
const NursesList = ({ nurses, sendNotificationToDoctor }) => {
      ...
      <div className="flex flex-wrap gap-4 justify-center items-center max-w-7xl px-4 py-5">
        {nurses.map((nurse) => (
          <div
            ...
            onClick={async () => {
              if (currentUser?.uid && nurse.userId) {
                await sendNotificationToDoctor(nurse.userId, currentUser.uid);
                router.push(
          ...
          >
            ...
            <Image
              src={nurse?.photoUrl || "/images/default_avatar.jpg"}
