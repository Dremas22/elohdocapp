...
const PatientDashboardHeader = ({ doctor = 0, nurse = 0 }) => {
    return (
        <div className="w-full flex flex-col items-center px-4 pt-10 text-3xl space-y-3">
            ...
            <div className="bg-gradient-to-br from-[#0b2345] to-[#123158] p-4 lg:ml-50 rounded-2xl shadow-2xl w-full max-w-xs text-center transform transition-transform duration-300 hover:shadow-[#0d6efd]/50 cursor-default">
                <h2 className="text-sm font-bold mb-2 tracking-wide text-[#90e0ef] drop-shadow-md">
                    Consultations Remaining
                </h2>
                <div className="text-[#90e0ef] text-xl flex flex-col sm:flex-row justify-center gap-2 sm:gap-x-6">
                    <p>
                        Doctor:{" "}
                        <span className="font-bold text-[#90e0ef]">{doctor}</span>
                    </p>
                    <p>
                        Nurse:{" "}
                        <span className="font-bold text-[#90e0ef] ">{nurse}</span>
                    </p>
                </div>
            </div>
