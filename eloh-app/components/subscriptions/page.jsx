            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto px-6">
                    ...
                    <div className="p-6">
                        <ul className="space-y-3 text-sm text-gray-700">
                            <li className="flex items-center gap-2">
                                <FaCheck className="text-blue-600" /> Unlimited Nurse Consultations
                            </li>
                            <li className="flex items-center gap-2">
                                <FaCheck className="text-blue-600" /> Nurse’s Prescription
                            </li>
                            <li className="flex items-center gap-2">
                                <FaCheck className="text-blue-600" /> Medical Certificate / Sick Note
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow">
                    ...
                    <div className="p-6">
                        <ul className="space-y-3 text-sm text-gray-700">
                            <li className="flex items-center gap-2">
                                <FaCheck className="text-blue-700" /> Nurse & Doctor Consultations
                            </li>
                            <li className="flex items-center gap-2">
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow">
                    <div className="bg-gradient-to-r from-blue-800 to-sky-700 p-6 text-white">
                        <h3 className="text-lg font-semibold">Once-Off Doctor Consultation</h3>
                        <div className="mt-6">
                            <p className="text-4xl font-extrabold">R99</p>
                    ...
                    <div className="p-6">
                        <ul className="space-y-3 text-sm text-gray-700">
                            ...
                            <li className="flex items-center gap-2">
                                <FaCheck className="text-blue-800" /> Medical Certificate / Sick Note
                            </li>
                        </ul>
                    </div>
                </div>
