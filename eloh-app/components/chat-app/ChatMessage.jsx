...
const ChatMessage = ({ message, currentUser }) => {
  ...
  return (
    ...
    >
      ...
      {!isSender && (
        <img
          src={message?.photoUrl || "/images/deafult_avatar.jpg"}
          alt="Sender Avatar"
      ...
      >
        ...
        {message.img && (
          <img
            src={message.img}
            alt="sent"
            className={`w-full max-h-72 rounded-2xl object-cover shadow-md ${
        ...
        <span className="text-[11px] text-gray-400 mt-1">
          ...
          {isSender && <span className="font-medium text-blue-500">(You)</span>}
        </span>
      </div>
    </div>
  );
