  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 px-2 sm:px-4">
      ...
      >
        ...
        {/* Header */}
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b pb-4 mb-6 border-gray-200 gap-2">
          <div>
            <p
              id="note-preview-title"
              className="text-sm sm:text-base font-semibold tracking-wide text-[#1b4965] py-1 rounded-md font-mono inline-block"
            >
              Practice No: {docPractice}
            </p>
          </div>
          <div className="text-left sm:text-right text-xs sm:text-sm text-gray-600">
            <p className="text-base font-semibold text-[#023e8a]">{docName}</p>
            <p className="break-words">{docEmail}</p>
            <p>{docPhone}</p>
          </div>
        </div>
