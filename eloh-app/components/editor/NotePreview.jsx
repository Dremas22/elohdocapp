...
import { FaDownload, FaHeartbeat } from "react-icons/fa";
...
const NotePreview = ({
  ...
  const handleDownload = async () => {
    ...
    // Convert OKLCH → RGB to fix html2canvas issues
    ...
    try {
      ...
      const padding = 20; // padding in px on all sides
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 px-2 sm:px-4">
      ...
      >
        ...
        <DownloadButton
          className="min-w-24 flex items-center justify-center gap-2 px-4 py-2 mt-3"
