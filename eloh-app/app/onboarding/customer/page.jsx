      ...
      <div className="w-full max-w-6xl bg-foreground rounded-3xl shadow-2xl p-8 sm:p-10 md:p-12 flex flex-col md:flex-row gap-10 md:gap-16">
        ...
        <div className="md:w-1/2 text-center md:text-left flex flex-col justify-center">
          ...
          <p className="text-gray-700 text-lg leading-relaxed mb-6">
            Let&apos;s complete your onboarding so you can start booking
            services, connecting with healthcare professionals, and managing
          ...
          <div className="space-y-4 text-base text-gray-600">
            ...
            <div className="flex items-start gap-2">
              <span className="text-blue-600 font-bold">✔</span>
              <span>
                Add a valid <strong>contact number</strong> so we can send
            ...
            <div className="flex items-start gap-2">
              <span className="text-blue-600 font-bold">✔</span>
              <span>
                Share your <strong>preferred service preferences</strong> for a
            ...
            <div className="flex items-start gap-2">
              <span className="text-blue-600 font-bold">✔</span>
              <span>
                Enjoy easy access to our digital healthcare ecosystem for
                bookings, e-consults, and more.
              </span>
            </div>
          </div>

          <p className="mt-6 text-sm text-gray-700 font-bold">
            Your privacy is our priority — all data is processed in accordance
            with POPIA and protected with industry-standard encryption
            protocols.
          </p>
        </div>
