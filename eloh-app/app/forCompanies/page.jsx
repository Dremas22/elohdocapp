...
export const metadata = {
  title: "For Companies | ElohApp",
  description:
    "Discover how ElohApp provides telehealth solutions tailored for businesses, helping your employees access healthcare seamlessly and efficiently.",
};
        ...
        <div className="mt-12 flex flex-col gap-16">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="md:w-1/2">
              ...
              <p className="mt-2 text-gray-600">
                Provide your staff with virtual medical consultations,
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="md:w-1/2">
              ...
              <p className="mt-2 text-gray-600">
                Custom health promotion, screening and wellness campaigns for
                your workforce.
              </p>
            </div>
            <div className="relative w-full md:w-1/2 h-[250px]">
